...
class VoIPms{
    ...
    function createSubAccount(
        ...
        $lock_international, $international_route, $music_on_hold, $allowed_codecs, $dtmf_mode, $nat, $sip_traffic, $max_expiry,
        $rtp_timeout, $rtp_hold_timeout,
        $ip_restriction,$enable_ip_restriction,$pop_restriction,$enable_pop_restriction,
        $internal_extension, $internal_voicemail, $internal_dialtime,
        $reseller_client, $reseller_package, $reseller_nextbilling, $reseller_chargesetup, $send_bye
    ){
        $function = "createSubAccount";
        $params = array(
            "params" => array(
    ...
    function getSMS($from,$to,$type,$did,$contact,$limit,$timezone="",$sms='',$all_messages=0){
        $function = "getSMS";
        $params = array(
            "params" => array(
                "api_username"  => $this->api_username,
    ...
    function getMMS($from,$to,$type,$did,$contact,$limit,$timezone="",$mms='',$all_messages=0){
        $function = "getMMS";
        $params = array(
            "params" => array(
                "api_username"  => $this->api_username,
    ...
    function getMediaMMS($id){
        $function = "getMediaMMS";
        $params = array(
            "params" => array(
                "api_username"  => $this->api_username,
                "api_password"  => $this->api_password,
    ...
    function setSubAccount(
        ...
        $international_route, $music_on_hold, $allowed_codecs, $dtmf_mode, $nat, $sip_traffic, $max_expiry,
        $rtp_timeout, $rtp_hold_timeout,
        $ip_restriction,$enable_ip_restriction,$pop_restriction,$enable_pop_restriction,
        $internal_extension, $internal_voicemail,
        $internal_dialtime, $reseller_client, $reseller_package, $reseller_nextbilling, $reseller_chargesetup,$send_bye
    ){
        $function = "setSubAccount";
        $params = array(
            "params" => array(
    ...
    function deleteFaxMessage($id, $test, $client){
    ...
    function delEmailToFax($id, $test, $client){
    ...
    function delFaxFolder($id, $test, $client){
    ...
    function getFaxNumbersInfo($did, $client){
    ...
    function getFaxMessages($from, $to, $folder, $id, $client){
    ...
    function getFaxMessagePDF($id, $client){
    ...
    function getFaxFolders($id, $client){
    ...
    function getEmailToFax($id, $client){
    ...
    function moveFaxMessage($fax_id, $folder_id, $test, $client){
    ...
    function orderFaxNumber($location, $quantity, $email, $email_enable, $email_attach_file, $url_callback, $url_callback_enable, $url_callback_retry, $test, $account){
    ...
    function setFaxFolder($name, $id, $test, $client){
    ...
    function sendFaxMessage($to_number, $from_name, $from_number, $send_email_enabled, $send_email, $station_id ,$file, $tif, $test, $client){
    ...
    function e911AddressTypes($type){
        $function = "e911AddressTypes";
        $params = array(
            "params" => array(
                "api_username" => $this->api_username,
                "api_password" => $this->api_password,
    ...
    function e911Provision($did, $full_name, $street_number, $street_name, $address_type, $address_number, $city, $state, $country, $zip_code, $language, $other_info){
        $function = "e911Provision";
        $params = array(
            "params" => array(
                "api_username"   => $this->api_username,
                "api_password"   => $this->api_password,
    ...
    function e911ProvisionManually($did, $full_name, $street_number, $street_name, $address_type, $address_number, $city, $state, $country, $zip_code, $language, $other_info){
        $function = "e911ProvisionManually";
        $params = array(
            "params" => array(
                "api_username"   => $this->api_username,
                "api_password"   => $this->api_password,
    ...
    function e911Update($did, $full_name, $street_number, $street_name, $address_type, $address_number, $city, $state, $country, $zip_code, $language, $other_info){
        $function = "e911Update";
        $params = array(
            "params" => array(
                "api_username"   => $this->api_username,
    ...
    function e911Validate($did, $full_name, $street_number, $street_name, $address_type, $address_number, $city, $state, $country, $zip_code, $language, $other_info){
        $function = "e911Validate";
        $params = array(
            "params" => array(
                "api_username"   => $this->api_username,
                "api_password"   => $this->api_password,
...
//     public function getAllSmsDid() {
//         $dids = $this->getDIDsInfo();

//         return collect($dids->dids)->filter(function($did) {
//             return ($did->sms_available == '1' && $did->sms_enabled == '1') ? $did->did : false;
//         })->toArray();
//     }
